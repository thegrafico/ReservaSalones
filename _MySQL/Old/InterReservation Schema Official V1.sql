...
create table Rooms(roomID varchar(10), capacity int, deptID varchar(10));
create table Department(deptName varchar(30), userID varchar(10), deptID varchar(10));
create table ProfHours(userID varchar(10), officeHour varchar(10), day varchar(10));
create table Reservation(email varchar(30), hour varchar(10), date date, status varchar(10), roomID varchar(10));
create table Appointment(email varchar(30), hour varchar(10), date date, status varchar(10), userID varchar(10));
create table RoomHours(roomID varchar(10), hour varchar(10), day varchar(10));                                          /*Hours Not Available*/
...
insert into ProfHours values(null, 'hour', 'day');

/* === Entering data to RoomHours === */

insert into RoomHours values('roomID', 'hour', 'day');

/* Department F First Floor*/

insert into RoomHours values('F102B', 'abcdefg', '');
insert into RoomHours values('F104', 'abcdefg', '');

/* Department F Second Floor*/

insert into RoomHours values('F201A', 'abcdefg', '');
insert into RoomHours values('F201B', 'abcdefg', '');
insert into RoomHours values('F203', '', '');
insert into RoomHours values('F209', 'abcdefg', '');
insert into RoomHours values('F210', 'abcdefg', '');
insert into RoomHours values('F214', '', '');
insert into RoomHours values('F219', 'abcdefg', '');
